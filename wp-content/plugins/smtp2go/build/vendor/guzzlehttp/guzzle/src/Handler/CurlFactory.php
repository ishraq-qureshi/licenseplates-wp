...
class CurlFactory implements CurlFactoryInterface
{
    ...
    public function create(RequestInterface $request, array $options) : EasyHandle
    {
        ...
        if ('' === $protocolVersion) {
            $protocolVersion = '1.1';
            $request = \SMTP2GOWPPlugin\GuzzleHttp\Psr7\Utils::modifyRequest($request, ['version' => $protocolVersion]);
        }
    ...
    private static function createRejection(EasyHandle $easy, array $ctx) : PromiseInterface
    {
        ...
        if ('' !== $sanitizedError) {
            $redactedUriString = \SMTP2GOWPPlugin\GuzzleHttp\Psr7\Utils::redactUserInfo($uri)->__toString();
    ...
    private static function sanitizeCurlError(string $error, UriInterface $uri) : string
    {
        ...
        $redactedUriString = \SMTP2GOWPPlugin\GuzzleHttp\Psr7\Utils::redactUserInfo($baseUri)->__toString();
