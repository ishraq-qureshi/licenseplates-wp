...
class CustomHeaderCollection extends Collection
{
     ...
     */
    const ALLOWED_MULTIPLE_HEADERS = ['comments', 'keywords', 'optional-field', 'trace', 'resent-date', 'resent-from', 'resent-sender', 'resent-to', 'resent-cc', 'resent-bcc', 'resent-msg-id'];
