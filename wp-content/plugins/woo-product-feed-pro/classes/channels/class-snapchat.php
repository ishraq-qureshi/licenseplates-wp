...
// phpcs:disable PEAR.NamingConventions.ValidClassName.Invalid -- legacy class name 'WooSEA_snapchat' is resolved dynamically as 'WooSEA_' . $channel_name in classes/class-get-products.php; renaming would break feed generation.
/**
 * Snapchat channel definition.
 */
class WooSEA_snapchat {
    /**
     * Snapchat product feed settings
     *
     * @var array
     */
    public $snapchat;
