 ...
 *
 * Copyright: (c) 2013-2025, SkyVerge, Inc. (info@skyverge.com)
 *
...
class WC_Authorize_Net_CIM_Loader {
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html( sprintf( 'You cannot clone instances of %s.', get_class( $this ) ) ), '2.10.0' );
	}
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, esc_html( sprintf( 'You cannot unserialize instances of %s.', get_class( $this ) ) ), '2.10.0' );
	}
