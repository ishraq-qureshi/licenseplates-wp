...
class WC_AF_Rule_Temporary_Email extends WC_AF_Rule {
	...
	public function __construct() {
		...
		parent::__construct( 'temporary_email', __('Email address is from a high-risk domain.', 'woocommerce-anti-fraud'), $this->rule_weight );
	}
	...
	public function is_risk( WC_Order $order ) {
		 ...
		 * @since  1.0.0
		 */
		$temp_email_domains = apply_filters(
			'wc_af_temporary_email_domains',
			array(
				'guerrillamail.com',
