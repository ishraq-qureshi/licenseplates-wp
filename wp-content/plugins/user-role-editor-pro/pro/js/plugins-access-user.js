...
var ure_plugins_access_user = {
            ...
            success: function(response) {
                ...
                if (typeof data.result !== 'undefined') {
                    if (data.result === 'success') {                    
                        ure_plugins_access_user.selection_dialog_show(data);
    ...
    selection_dialog_show: function(data) {
        ...
        dialog_title = ure_plugins_access_user.selection_dialog_title();
        jQuery('#ure_plugins_access_dialog').dialog({
            ...
            'buttons'       : {
            'Update': function () {                                  
                ure_plugins_access_user.save_user_selection();
...
jQuery(function(){
    ...
    jQuery("#ure_edit_allowed_plugins").button().on('click', (function(event) {
        ...
        ure_plugins_access_user.selection_dialog_prepare();                
    }));
