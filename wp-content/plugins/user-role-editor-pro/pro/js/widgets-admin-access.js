var ure_widgets_access = {
    ...
    dialog_show: function( data ) {
      ...
      jQuery('#dialog-update-button').html( ure_ui_button_text( ure_data_widgets_access.update_button ) );
      jQuery('.ui-dialog-buttonpane button:contains("Cancel")').attr("id", "dialog-access-cancel-button");
      jQuery('#dialog-access-cancel-button').html( ure_ui_button_text( ure_data.cancel ) );      
