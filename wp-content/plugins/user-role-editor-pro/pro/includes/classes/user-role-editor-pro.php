...
*/        
        ...
        $check_updates = apply_filters('ure_check_updates', true );
        if ( $check_updates ) {
            $this->init_updater();
        }
...
/*
        ...
        $links = ure_array_merge($links, array($settings_link));
*/
        return $links;
    }
    ...
    public function add_js_settings() {
        ...
        wp_localize_script( 'ure-settings-pro', 'ure_settings_data_pro', 
                array(
                    ...
                    'select_file_with_roles' => esc_html__('Select file with roles', 'user-role-editor'),
                    '_button' => esc_html__('Import', 'user-role-editor'),
