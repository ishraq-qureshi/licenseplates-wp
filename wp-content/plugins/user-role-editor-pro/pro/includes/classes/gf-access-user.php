...
class URE_GF_Access_User {    
    ...
    public static function show_options( $user ) {
        ...
        if ( stripos( $request_uri, 'network/user-edit.php') !== false ) {  // exit, this code just for single site user profile only, not for network admin center UI
            return;
        }
    ...
    public static function get_allowed_forms() {
        ...
        $allowed_forms_list = (array) apply_filters('ure_get_allowed_gf_forms', $allowed_forms);
