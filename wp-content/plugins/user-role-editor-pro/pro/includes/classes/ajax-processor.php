...
class URE_Pro_Ajax_Processor extends URE_Ajax_Processor {
    ...
    protected function get_other_roles_list() {
        $other_roles = new URE_Other_Roles();
        $answer = $other_roles->get_html();
        
        return $answer;
    }
    // end of get_other_roles_list()
    ...
    private function meta_boxes_access_update() {
        
        $answer = URE_Meta_Boxes_Access::update_data();
        
        return $answer;
    }
    // end of meta_boxes_access_update()
    ...
    private function other_roles_access_update() {
        
        $answer = URE_Other_Roles::update_data();
        
        return $answer;
    }
    // end of other_roles_access_update()
    ...
    private function posts_edit_access_update() {
        
        $answer = URE_Posts_Edit_Access_Role_Controller::update_data();
    ...
    private function plugins_access_update() {
        
        $answer = URE_Plugins_Access_Role_Controller::update_data();
    ...
    protected function _dispatch() {
        ...
        if ( !isset( $answer['message'] ) || substr( $answer['message'], 0, 14)!='Unknown action' ) {
            return $answer;
        }
        ...
        switch ($this->action) {            
            ...
            case 'get_other_roles_list': {
                $answer = $this->get_other_roles_list();
                break;
            }
            ...
            case 'meta_boxes_access_update': {
                $answer = $this->meta_boxes_access_update();
                break;
            }
            ...
            case 'other_roles_access_update': {
                $answer = $this->other_roles_access_update();
                break;
            }
            case 'plugins_access_update': {
                $answer = $this->plugins_access_update();
                break;
            }
            ...
            case 'posts_edit_access_update': {
                $answer = $this->posts_edit_access_update();
                break;
            }
