...
if (isset($_REQUEST['admin_logging']))
    { 	// I register and initializate the admin logged variable
            $_SESSION['admin_logged']=true;

            // I setup the cart to show the custom request products
            $_SESSION['cart']->setDisplayCustomRequestProds(true);
    }